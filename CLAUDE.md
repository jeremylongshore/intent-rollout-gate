...
- **Evidence Bundle SPEC** — what we consume: [`intent-eval-lab/specs/evidence-bundle/v0.1.0-draft/SPEC.md`](https://github.com/jeremylongshore/intent-eval-lab/blob/main/specs/evidence-bundle/v0.1.0-draft/SPEC.md). R14–R16 are the policy-consumption contract this action implements.
...
**Do not** start M5 work without first reading the architecture doc § "Language choice" — the deferred decision is non-trivial and locks the maintenance surface for years.
